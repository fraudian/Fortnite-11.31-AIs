...
public:
	...
	uint8                                        Pad_9[0x38];                                       // Fixing Size After Last (Predefined) Property  [ Dumper-7 ]
	class UObject*                               DefaultObject;                                     // (0xF8[0x08]) NOT AUTO-GENERATED PROPERTY
	uint8                                        Pad_A[0x100];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_B[0x48];                                       // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_10[0x68];                                      // Fixing Size Of Struct [ Dumper-7 ]
