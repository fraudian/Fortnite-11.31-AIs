...
{
public:
	uint8                                        Pad_68B[0x80];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_69E[0x6];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_6A3[0x18];                                     // Fixing Size After Last Property  [ Dumper-7 ]
