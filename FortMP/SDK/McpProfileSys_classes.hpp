...
public:
	...
	uint8                                        Pad_65E[0x57];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_661[0x1D];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_665[0x3C];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_66F[0xF4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_674[0x40];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_67A[0x56];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_67C[0xC];                                      // Fixing Size Of Struct [ Dumper-7 ]
