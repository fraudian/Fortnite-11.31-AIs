...
{
public:
	uint8                                        Pad_14AB[0x58];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_14B4[0x17];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_155B[0x2C];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_155C[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_15A6[0x1E8];                                   // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_15B5[0xB0];                                    // Fixing Size Of Struct [ Dumper-7 ]
