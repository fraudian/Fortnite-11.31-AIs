...
public:
	...
	uint8                                        Pad_1CF[0x6];                                      // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1D4[0xD8];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_1D6[0xE];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1D7[0x30];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1D8[0x10];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1E2[0xF];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_1E8[0xE];                                      // Fixing Size After Last Property  [ Dumper-7 ]
