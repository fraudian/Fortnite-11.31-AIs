...
{
public:
	uint8                                        Pad_C6E[0x20];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_C78[0xC0];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_C7A[0x20];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_C82[0x30];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_C8C[0x68];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_C8D[0x18];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_C97[0xE0];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_C9A[0x28];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_C9D[0x70];                                     // Fixing Size After Last Property  [ Dumper-7 ]
